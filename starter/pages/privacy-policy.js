            ...
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
                  ...
                  <li>Property listing information (address, photos, descriptions)</li>
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">2.3 Property Information</h3>
                <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
                  <li>Property photos and descriptions</li>
                  <li>Location and pricing details</li>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
                  <li><strong>Service Delivery:</strong> To provide, maintain, and improve our rental property platform</li>
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">4.1 Public Property Listings</h3>
                <p className="text-gray-700 mb-4">
                  Property information you choose to list (photos, descriptions, contact details) will be publicly visible to all users of our platform.
                </p>
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700">
                  Your information may be transferred to and processed in countries other than Jamaica. We ensure appropriate safeguards are in place to protect your information in accordance with this Privacy Policy.
                </p>
              </section>
